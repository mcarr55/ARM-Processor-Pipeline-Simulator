...
At the end of the program after 2 HLT instruciotns, the program ends and the cucle each intruciton exited each phaase is lisited. As well as the requests and successfult hits from the intruction and data caches.
